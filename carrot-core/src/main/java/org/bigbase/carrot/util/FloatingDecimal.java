...
public class FloatingDecimal{
     ...
     */
    public static void toJavaFormatMutableString(double d, MutableString str) {
        getBinaryToASCIIConverter(d).toJavaFormatMutableString(str);
    }
     ...
     * @return The value converted to a <code>String</code>.
     */
    public static void toJavaFormatMutableString(float f, MutableString str) {
        getBinaryToASCIIConverter(f).toJavaFormatMutableString(str);
    }
    ...
    public interface BinaryToASCIIConverter {
        ...
        default public void toJavaFormatMutableString(MutableString str) {
          // does nothing
        }
        /**
    ...
    static class BinaryToASCIIBuffer implements BinaryToASCIIConverter {
        ...
        @Override 
        public void toJavaFormatMutableString(MutableString str) {
          int len = getChars(buffer);
