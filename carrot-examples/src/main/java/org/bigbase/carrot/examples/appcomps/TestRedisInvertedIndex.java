 ...
 * 
 * We emulate 1000 words and some set of docs. 
 * Maximum occurrence of a single word is 5000 docs (random number between 1 and 5000)
 * Each doc is coded by 4-byte integer
 * 
 * Each word is a random 8 byte value
 * 
