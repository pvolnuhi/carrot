 ...
 *  
 *  Confirmed: Redis consumes 19 bytes per host in a highly optimized representation of a large 
 ...
 *  RAM usage (Redis-to-Carrot)
 * 
 * 1) No compression    10M/8.5M ~ 1.18x
 * 2) LZ4   compression 10M/6.6M ~ 1.5x
 * 3) LZ4HC compression 10M/6.1M ~ 1.65x 
 * 
 *  
 *  
 * @author vrodionov
