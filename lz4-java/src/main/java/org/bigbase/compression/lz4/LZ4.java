...
public class LZ4 {
	 ...
	 */
	public static native int compressDirect(ByteBuffer src, int offset, int len, ByteBuffer dst, int where, int dstCapacity);
	
	public static native int compressDirectHC(ByteBuffer src, int offset, int len, ByteBuffer dst, int where, int dstCapacity);

	public static native int compressDirectAddress(long src, int len, long dst, int dstCapacity);
	
	public static native int compressDirectAddressHC(long src, int len, long dst, int dstCapacity, int level);
	/**
	 ...
	 */
	public static native int decompressDirect(ByteBuffer src, int offset, int origSize, ByteBuffer dst, int where, int dstCapacity);
	
	public static native int decompressDirectHC(ByteBuffer src, int offset, int origSize, ByteBuffer dst, int where, int dstCapacity);
  
	public static native int decompressDirectAddress(long src,  int compressedSize, long dst, int dstCapacity);
	
	public static native int decompressDirectAddressHC(long src,  int compressedSize, long dst,  int dstCapacity);
