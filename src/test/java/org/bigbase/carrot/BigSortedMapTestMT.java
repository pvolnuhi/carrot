...
public class BigSortedMapTestMT {
  ...
  static class Worker extends Thread {
    ...
    private void runScan() {
      ...
      BigSortedMapScanner scanner = map.getScanner(startKey, endKey);
      long counter = 0;
  ...
  @Test
	public void testPerf() throws IOException {
		...
		while (cycle++ < totalCycles) {
			...
			BigSortedMap map = new BigSortedMap((long)  20 * 1024 * 1024 * 1024);
			...
			System.out.println("MEM=" + DataBlock.getTotalAllocatedMemory() + "\nDATA=" + DataBlock.getTotalDataSize()
					+ "\nUTILIZATION=" + (((double) DataBlock.getTotalDataSize()) / DataBlock.getTotalAllocatedMemory()));
